...
@Autonomous(name = "Pedro Autonomous 9 Balls Blue", group = "Autonomous")
@Configurable // Panels
public class PedroAutonomous9BallBlue extends OpMode {
    ...
    public static class Paths {
        ...
        public final Pose pickup1Pose = new Pose(38, 90, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
